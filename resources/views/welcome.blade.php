...
@section('content')
    <div class="md:flex pt-6 bg-white">
        ...
        <div class="relative md:w-2/5 text-center md:text-left text-gray-600 px-4 py-2 z-10">
            <div class="md:pl-24 md:py-16">
                <h1 class="text-2xl sm:text-xl md:text-2xl lg:text-4xl xl:text-6xl antialiased tracking-tight leading-none"> Superlijm voor je <span class="font-bold">brein</span> </h1>
