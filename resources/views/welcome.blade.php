    ...
    <div class="container md:flex md:flex-row-reverse mx-auto mt-6">
        ...
        <div class="px-4 py-2 lg:w-1/2 text-center lg:text-left text-gray-600">
            <div class="lg:pl-24 lg:py-16">
                ...
                <a href=" {{ route('register') }} " class="inline-block w-full px-8 mr-4 lg:w-auto bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 rounded"> Make account </a>
                <a href="#" class="inline-block w-full px-8 lg:w-auto bg-gray-200 hover:bg-blue-700 text-gray-700 hover:text-white font-bold py-2 rounded"> Browse tests </a>
            </div>
        </div>
    </div>
